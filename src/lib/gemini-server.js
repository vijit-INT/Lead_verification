...
/**
 * Server-side: Uses Gemini to extract and structure data from raw search results
 */
export async function enrichProfileServer(searchResults, userData) {
  if (!genAI) {
...
/**
 * Server-side: Handles follow-up questions from the user based on previous intelligence and new global searches
 */
export async function askFollowUpServer(question, previousResults, newSearchResults) {
